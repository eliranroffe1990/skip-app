...
var CACHE='skipapp-v5.3.0';
var CORE=['.','index.html','manifest.json','app.js?v=5230','icon/icon-192.png','icon/icon-512.png','icon/icon-180.png','images/hero.jpg','images/play_logo.png'];
