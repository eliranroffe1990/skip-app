...
var CACHE='skipapp-v5.2.2';
var CORE=['.','index.html','manifest.json','app.js?v=5222','icon/icon-192.png','icon/icon-512.png','icon/icon-180.png','images/hero.jpg','images/play_logo.png'];
